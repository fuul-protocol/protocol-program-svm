...
export const grantProjectRoleCommand = new Command('grant-project-role')
  .requiredOption(
    '-n, --network <network>',
  ...
  .requiredOption('--role <role>', 'The role to grant (admin)')
  .action(async (options) => {
    ...
    const grantProjectRoleIx = await sdk.grantProjectRole({
    ...
    const tx = new Transaction().add(...grantProjectRoleIx);
